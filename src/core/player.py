...
# does not inherit from Player
class SamplePlayer:
    def __init__(self, name, number, team, league, positions=None, message=None, parent=None):
...
class Player:
    ...
    def limit_at_bat(self, stat, val):
        return (stat + val) > self.at_bat
...
class Pitcher(Player):
    def __init__(self, name, number, team, league, positions=None, message=None):
        if positions is None:
            positions = []
        super().__init__(name, number, team, league, positions=positions, message=message)
    ...
    def get_p_at_bats(self):
        return self.p_at_bats